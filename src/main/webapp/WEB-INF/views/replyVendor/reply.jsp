            ...
            <div class="size">
                ...
                <input type="hidden" name="isIframe" value="${isIframe}">
                    ...
                    <div class="btnSet"  style="text-align:right;">
                    	<a class="btn" href="view?reply_vendor_id=${origin.reply_vendor_id}&isIframe=${isIframe}" style="background-color: #888 !important; margin-right: 5px;">취소</a>
