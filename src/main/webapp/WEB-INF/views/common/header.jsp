...
.search-bar input { border: none; outline: none; width: 150px; font-size: 14px; background: transparent; }
.search-btn { border: none; background: transparent; cursor: pointer; font-size: 16px; line-height: 1; }
...
.search-panel:hover { display: block; }
.search-panel::before { content:""; position:absolute; top:-10px; left:0; right:0; height:10px; }

.panel-header { display:flex; justify-content:space-between; align-items:center; margin-bottom:8px; font-size:13px; }
.clear-btn { border:none; background:transparent; cursor:pointer; color:#666; font-size:12px; }
.clear-btn:hover { color: var(--main-color); }
...
.recent-keyword { font-size:13px; color:#333; cursor:pointer; }
.recent-keyword:hover { color: var(--main-color); }
.recent-del { border:none; background:transparent; cursor:pointer; color:#999; font-size:12px; }
.recent-del:hover { color:#333; }
.empty-recent { display:none; color:#888; font-size:12px; margin-top:6px; }
</style>
  ...
  <div class="nav-container">
    ...
    <div class="nav-icons">
      <div class="search-wrap" id="searchWrap">
        <form id="headerSearchForm" method="get" action="${pageContext.request.contextPath}/search">
          <div class="search-bar">
            <input id="headerSearchInput" type="text" name="q" placeholder="검색" autocomplete="off">
        ...
        <div class="search-panel" id="searchPanel">
          <div class="panel-header">
            ...
            <button type="button" id="clearRecentBtn" class="clear-btn">전체삭제</button>
          </div>
          <ul id="recentList" class="recent-list"></ul>
          <div id="emptyRecent" class="empty-recent">최근 검색어가 없습니다.</div>
        </div>
      </div>
