...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .user-icon { font-size: 22px; cursor: pointer; }
        ...
        .recommend-section { 
            ...
            width: 100%; 
            margin-bottom: 80px; 
            min-height: 450px; /* 👈 추천 콘텐츠가 없어도 충분한 높이 확보 */
            background: #fafafa;
            border-radius: 25px;
            padding: 40px 0;
        }
        ...
        .card-img-wrap { width: 100%; height: 280px; border-radius: 15px; overflow: hidden; margin-bottom: 15px; border: 1px solid #eee; background:#fff; }
        ...
        /* 4. 기타 섹션 스타일 */
        .section-title { font-size: 26px; font-weight: bold; margin-bottom: 30px; text-align: center; }
...
<body>
    ...
    <header class="header">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                <li><a href="#">Q&A</a></li>
                <li><a href="${pageContext.request.contextPath}/popup" style="color: var(--main-color);">PopUp</a></li>
    ...
    <main class="main-wrapper">
        ...
        <section class="recommend-section">     
            <c:set var="isLoggedIn" value="${not empty loginUser}" />
            ...
            <div class="hot-grid-container">
                <c:if test="${not empty popularList}">
                    <div class="hot-main" onclick="location.href='${pageContext.request.contextPath}/detail/${popularList[0].content_id}'">
                        ...
                        <div class="banner-info" style="position:absolute; bottom:0; left:0; width:100%; padding: 20px; background: linear-gradient(transparent, rgba(0,0,0,0.7)); color:white;">
                            <h3>${popularList[0].title}</h3>
                        </div>
                    </div>
