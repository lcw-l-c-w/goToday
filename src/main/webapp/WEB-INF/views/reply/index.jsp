                  ...
                  <div class="list-wrap">
                    ...
                    <p class="btnSet" style="text-align:right; margin-top:-30px;">
					    <c:if test="${!empty loginSess}">
					        <a class="btn" href="write.do">문의사항 남기기</a>
					    </c:if>
					    <c:if test="${empty loginSess}">
                    		<br>
					    </c:if>
                        ...
                        <c:forEach var="vo" items="${map.list }">       
                            <tr>
                                ...
                                <td style="text-align:left;">
                                    <a href="view.do?reply_id=${vo.reply_id}">
                                    	${vo.title }
                                    	<c:if test="${vo.answer_count > 0}"><span class="reply-count">[${vo.answer_count}]</span></c:if>
									</a>
                                </td>
                                <td class="writer">
                                	<c:choose>
                        ...
                        <form method="get" name="searchForm" id="searchForm" action="index.do">
                            <span class="srchSelect">
                                <select id="stype" name="searchType" class="dSelect" title="검색분류 선택">
                                    ...
                                    <option value="body" <c:if test="${replyVO.searchType == 'body'}">selected</c:if>>내용</option>
                                </select>
                            </span>
